  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingOne">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            Humpback whale (Megaptera novaeangliae)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne">
        <div class="row" style="padding: 1%;">
            <div class="col-sm-5" >
                <img src="assets/images/hw1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">    
                    <div class="card-block">
                        <p class="card-text">
                        Humpback whales are one of the most common species of whale you will see in Australian waters and are well known for their spectacular breaching behaviour. They have very long pectoral fins and obvious throat grooves. Humpback whales also have a small dorsal fin located nearly two-thirds of the way down their back, and their backs steeply arch as they dive – this is how the humpback got its name and it helps whale watchers distinguish them from other species.<br/><br/>Most people will see humpback whales while they are travelling along the east and west coast of Australia on their annual migration to and from Antarctic waters however they will sometimes be seen off South Australia. In some areas humpback whales are viewed while resting in relatively shallow bays, such as Hervey Bay in Queensland. Occasionally whale watchers may see a humpback whale feeding, such as off the coast near Eden in NSW.<br/><br/>While humpback whales appear to tolerate the presence of whale watchers it is important to note that in some situations they may be more sensitive to disturbance. This is particularly the case when adults are accompanied by young calves or when animals are feeding or competing for mates.  
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(1)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
                <button type="button" class="btn btn-default" onclick="playSound(2)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
                <button type="button" class="btn btn-default" onclick="playSound(3)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingTwo">
      <h4 class="panel-title">
        ...
        Southern right whale (Eubalaena australis)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/srw1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <p class="card-text">
                        The southern right whale is a large whale that is easily distinguished from others because of its broad back without a dorsal fin, wide pectoral fins, a long arching mouth that begins above the eye and small rough patches of skin (or callosities) on its head. <br/><br/>In Australian waters, southern right whales migrate between summer feeding grounds in Antarctic waters to more temperate inshore waters off the coast of southern Western Australia, South Australia, Tasmania, Victoria and New South Wales in winter. Within this coastal habitat southern right whales tend to occur in very shallow water, including in estuaries and bays. They have even been known to swim into the surf zone. 
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(4)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingThree">
      <h4 class="panel-title">
        ...
        BLUE WHALE (BALAENOPTERA MUSCULUS)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseThree" class="panel-collapse collapse" aria-labelledby="headingThree">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/bw1.jpeg" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <p class="card-text">
                        Blue whales are the largest animal on earth with an average length of 24 meters and a weight of up to 136 tonnes. Blue whales have grey blue skin with white spots and a small dorsal fin set far back on their body.<br/><br/> Blue whales are typically seen in deeper offshore waters where large upwellings bring krill, their preferred food, to the surface.  Some of the most likely places to see a blue whale in Australian waters is off the coasts of Victoria and South Australia in an area known as the Bonney upwelling and off the Western Australian coast in the Perth Canyon.
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(5)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingFour">
      <h4 class="panel-title">
        ...
        Dwarf minke whale (Balaenoptera acutorostrata)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseFour" class="panel-collapse collapse" aria-labelledby="headingFour">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/dmw1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        ...
                        <br/><br/>Dwarf minke whales mostly swim alone or in pairs, although groups may form at feeding sites. Minke whales are known to be curious, often approaching boats or swimmers. In the northern Great Barrier Reef area this inherently inquisitive behaviour has led to dwarf minke whales becoming the subject of a swim-with whale program managed by the Great Barrier Reef Marine Park Authority. The distribution of this species in Australian waters is not well understood but does extend at least from sub-Antarctic waters to waters off the northern Great Barrier Reef and north Western Australia.
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(6)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingFive">
      <h4 class="panel-title">
        ...
        Killer whale (Orcinus orca)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseFive" class="panel-collapse collapse" aria-labelledby="headingFive">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/kw1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        ...
                        <br/><br/>This species is generally seen in groups averaging about 10 animals. While killer whales are seen in all Australian waters they are most commonly seen in coastal waters and along the continental shelf off the southern states of Australia.
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(7)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingSix">
      <h4 class="panel-title">
        ...
        Common bottlenose dolphin (Tursiops truncatus)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseSix" class="panel-collapse collapse" aria-labelledby="headingSix">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/cbd1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
            ...
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(8)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingSeven">
      <h4 class="panel-title">
        ...
        Australian humpback dolphin (Sousa sahulensis)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseSeven" class="panel-collapse collapse" aria-labelledby="headingSeven">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/ahd1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
...
<br/><br/>This species is found in waters that extend from the New South Wales/Queensland border across Northern Australia to Ningaloo Reef, near Exmouth.
            ...
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(9)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingEight">
      <h4 class="panel-title">
        ...
        Australian snubfin dolphin (Orcaella heinsohni)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseEight" class="panel-collapse collapse" aria-labelledby="headingEight">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/asd1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
...
<br/><br/>The Australian snubfin dolphin occurs only in waters off the northern half of Australia, from approximately Broome on the west coast to the Brisbane River on the east coast. This species occurs mostly in protected shallow waters close to the coast, and close to river and creek mouths.
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(10)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingNine">
      <h4 class="panel-title">
        ...
        Common dolphin (Delphinus delphis)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseNine" class="panel-collapse collapse" aria-labelledby="headingNine">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/cd1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <p class="card-text">
                        Common Dolphins are slender, with a long beak protruding sharply from the head. The dorsal fin is high and curves backwards. <br/><br/>Common Dolphins are mostly found in offshore waters, however occasionally they occur in near-shore areas. They have been recorded in waters off all Australian states and territories, but are rarely seen in northern Australian waters.
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(11)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading"  id="headingTen">
      <h4 class="panel-title">
        ...
        Spinner dolphin (Stenella longirostris)<i class="fa fa-2x fa-angle-down" style="float:right;margin-top:-5px;"></i>
        </a>
      </h4>
    </div>
    <div id="collapseTen" class="panel-collapse collapse" aria-labelledby="headingTen">
        <div class="row" style="padding: 1%">
            <div class="col-sm-5" >
                <img src="assets/images/sd1.png" alt="Card image" class="img-responsive center-block"/>
            </div>
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        ...
                        <br/> <br/>In Australia, spinner dolphins occur from Western Australia, through Northern Territory waters and along the east coast from Queensland to NSW, including the Great Barrier Reef.    
                        </p>
                    </div>
                </div>
            </div>
            <div style="padding-left:2%">
                <button type="button" class="btn btn-default" onclick="playSound(12)">
                    <span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span> Play
                </button>
            </div>
        </div>
